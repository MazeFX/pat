...
class Ui_LetterForm(object):
    def setupUi(self, LetterForm):
        ...
        self.formLayout.setWidget(2, QtWidgets.QFormLayout.FieldRole, self.UserLineEdit)
        ...
        self.formLayout.setWidget(3, QtWidgets.QFormLayout.FieldRole, self.senderLineEdit)
        ...
        spacerItem = QtWidgets.QSpacerItem(40, 100, QtWidgets.QSizePolicy.MinimumExpanding, QtWidgets.QSizePolicy.Minimum)
