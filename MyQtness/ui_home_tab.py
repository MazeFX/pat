...
class Ui_HomeTab(object):
    def setupUi(self, HomeTab):
        ...
        self.LogoContainer = QtWidgets.QLabel(HomeTab)
        self.LogoContainer.setMaximumSize(QtCore.QSize(16777215, 256))
        self.LogoContainer.setText("")
        self.LogoContainer.setScaledContents(True)
        ...
        spacerItem1 = QtWidgets.QSpacerItem(40, 300, QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Minimum)
...
"}")
        ...
        spacerItem2 = QtWidgets.QSpacerItem(40, 250, QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Minimum)
