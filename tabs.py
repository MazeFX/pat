    ...
    def __init__(self, dbhelper, *args):
        ...
        model = AlchemicalTableModel(
            ...
            [('Relation', Contract.relation, 'relation.name', {}),
             ...
             ('Type', Contract.contract_type, 'contract_type.contract', {}),
             ('Total amount', Contract.total_amount, 'total_amount', {'type': 'currency', }),
             ('Recurring amount', Contract.recur_amount, 'recur_amount', {'type': 'currency', }),
             ('Recurrence', Contract.recurrence, 'recurrence', {'type': 'recurrence', }),
